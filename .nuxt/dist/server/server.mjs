...
const __nuxt_page_meta$6 = { layout: "portal", middleware: ["auth", "admin"] };
const __nuxt_page_meta$5 = { layout: "portal", middleware: ["auth", "admin"] };
const __nuxt_page_meta$4 = { layout: "portal", middleware: ["auth", "admin"] };
const __nuxt_page_meta$3 = { layout: "portal", middleware: ["auth", "admin"] };
const __nuxt_page_meta$2 = { layout: "portal", middleware: ["auth", "admin"] };
const __nuxt_page_meta$1 = { layout: "portal", middleware: ["auth", "admin"] };
const __nuxt_page_meta = { layout: false, middleware: ["auth"] };
...
const _routes = [
  {
    name: "about",
    path: "/about",
    component: () => import("./_nuxt/about-BfYG1R76.js")
  },
  {
    name: "book",
    path: "/book",
    meta: __nuxt_page_meta$9 || {},
    component: () => import("./_nuxt/book-C35b_goz.js")
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import("./_nuxt/contact-Dgh89iDF.js")
  },
  {
    name: "impressum",
    path: "/impressum",
    component: () => import("./_nuxt/impressum-BEi4dAtj.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-DsV1vRuU.js")
  },
  {
    name: "join-id",
    path: "/join/:id()",
    meta: __nuxt_page_meta$8 || {},
    component: () => import("./_nuxt/_id_-DcOqUG2s.js")
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta$7 || {},
    component: () => import("./_nuxt/login-Bltw63my.js")
  },
  {
    name: "portal-admin-appointments",
    path: "/portal/admin/appointments",
    meta: __nuxt_page_meta$5 || {},
    component: () => import("./_nuxt/appointments-BCR9X0qX.js"),
    children: [
      {
        name: "portal-admin-appointments-create",
        path: "create",
        meta: __nuxt_page_meta$6 || {},
        component: () => import("./_nuxt/create-BxdnCVWf.js")
      }
    ]
  },
  {
    name: "portal-admin-availability",
    path: "/portal/admin/availability",
    meta: __nuxt_page_meta$4 || {},
    component: () => import("./_nuxt/availability-EyOvtoWT.js")
  },
  {
    name: "portal-admin",
    path: "/portal/admin",
    meta: __nuxt_page_meta$3 || {},
    component: () => import("./_nuxt/index-DfRuZPoH.js")
  },
  {
    name: "portal-admin-messages",
    path: "/portal/admin/messages",
    meta: __nuxt_page_meta$2 || {},
    component: () => import("./_nuxt/messages-DRo5WMrt.js")
  },
  {
    name: "portal-admin-patients",
    path: "/portal/admin/patients",
    meta: __nuxt_page_meta$1 || {},
    component: () => import("./_nuxt/patients-BhVgtjsQ.js")
  },
  {
    name: "portal",
    path: "/portal",
    meta: __nuxt_page_meta || {},
    component: () => import("./_nuxt/index-CmwEbC1P.js")
  },
  {
    name: "privacy",
    path: "/privacy",
    component: () => import("./_nuxt/privacy-Bk6C_92R.js")
  }
];
...
const namedMiddleware = {
  admin: () => import("./_nuxt/admin-By8LFP8k.js"),
  auth: () => import("./_nuxt/auth-CO2Kh08p.js")
};
...
const localeLoaders = {
  "en": [{ key: "../locales/en.json", load: () => import(
    "./_nuxt/en-DpaayP6W.js"
    /* webpackChunkName: "locale__Users_Rudolf_Work_mai_locales_en_json" */
  ), cache: true }],
  "de": [{ key: "../locales/de.json", load: () => import(
    "./_nuxt/de-BEXF-f9F.js"
    /* webpackChunkName: "locale__Users_Rudolf_Work_mai_locales_de_json" */
  ), cache: true }]
};
const vueI18nConfigs = [
  () => import(
    "./_nuxt/i18n.config-CNjtlAYE.js"
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default-CZ1yWd79.js").then((m) => m.default || m)),
  portal: defineAsyncComponent(() => import("./_nuxt/portal-BI7bFXCz.js").then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-zkASLRA6.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-CE23TJuS.js"));
