  ...
  <section class="section-padding pb-24 sm:pb-28 lg:pb-36 relative overflow-hidden bg-sage-mist">
    ...
    <div class="container-narrow relative z-10">
      <div class="max-w-2xl mx-auto text-center">
        <div class="w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-sage/10 flex items-center justify-center mx-auto mb-5 sm:mb-7">
          <i class="fa-solid fa-heart-pulse text-lg sm:text-xl text-sage"></i>
        </div>

        <h2 class="text-3xl md:text-4xl lg:text-5xl font-serif font-semibold text-charcoal text-balance mb-4 sm:mb-5">
          {{ $t('final_cta.title') }}
        </h2>
        <p class="text-base md:text-lg text-body/70 leading-relaxed mb-8 sm:mb-10 max-w-xl mx-auto">
